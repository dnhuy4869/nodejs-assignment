        ...
        <>
            <div className="min-h-screen flex justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-md w-full space-y-8">
                    <div>
                        <h2 className="mt-6 text-center text-4xl font-extrabold text-gray-300">Login page</h2>
                    </div>
                    <form className="mt-8 text-white" onSubmit={formik.handleSubmit}>
                        ...
                        <button type="submit" className='mt-6 w-full btn-primary px-6 py-2 font-bold'>Login</button>
                    {
                            message.message !== "" && !message.isSuccess
                                ? (
